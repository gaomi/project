                ...
                <div class="box-body">
                    <div class="row">
                        <div class="table-responsive col-md-12">
                            <div id="toolbar">
                                <form class="form-inline" id="eam_depart_search_form" style="margin-bottom: 10px;">
                            ...
                            <table id="eam_depart_table" class="table table-bordered table-striped text-nowrap">
                            </table>
                        </div>
                    </div>
                </div>
...
<script src="${ctx }/static/js/module/inspect/eam/depart/list.js"></script>
