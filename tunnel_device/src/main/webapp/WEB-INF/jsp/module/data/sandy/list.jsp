                ...
                <div class="box-body">
                    <div class="row">
                        <div class="table-responsive col-md-12">
                            <div id="toolbar">
                                <form id="data_sandy_search_form" class="form-inline" style="margin-bottom: 10px;">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="sandyType_search_select">区间</label>
                                        <div class="input-group">
                                            <div class="input-group-addon">区间</div>
                                            <select class="form-control" id="sandyType_search_select">
                                    ...
                                    <div class="pull-right">
                                        <button type="button" class="btn btn-primary queryButton" onclick="searchSy();">查询</button>
                                        <button type="button" class="btn btn-primary" paoding-modal-size="600_600" onclick="openEditPage('data_sandy','add',this);">添加
                                        </button>
                            ...
                            <table id="data_sandy_table" class="table table-bordered table-striped text-nowrap">
                            </table>
                        </div>
                    </div>
                </div>
...
<script src="${ctx }/static/js/module/data/sandy/list.js"></script>
