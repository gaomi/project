                ...
                <div class="box-body">
                    <div class="row">
                        <div class="table-responsive col-md-12">
                            <div id="toolbar">
                                <form class="form-inline" id="api_aqbhq_search_form" style="margin-bottom: 10px;">
                            ...
                            <table id="api_aqbhq_table" class="table table-bordered table-striped text-nowrap">
                            </table>
                        </div>
...
<script src="${ctx }/static/js/module/data/api/aqbhq.js"></script>