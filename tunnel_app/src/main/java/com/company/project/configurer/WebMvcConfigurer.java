...
public class WebMvcConfigurer extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        if (!"dev".equals(env)) {
            ...
            interceptor.excludePathPatterns("/app/login**");
            //swagger
            //interceptor.excludePathPatterns("/swagger-ui.html/**","/webjars/**","/configuration/ui","/swagger**","/v2/api-docs");
            ...
            interceptor.excludePathPatterns("/error");
            interceptor.excludePathPatterns("/app/login**");
            interceptor.excludePathPatterns("/app/info/getDeviceInfo");
            //swagger
            interceptor.excludePathPatterns("/swagger-ui.html/**", "/webjars/**", "/swagger-resources/**", "/configuration/ui", "/v2/api-docs");
            interceptor.addPathPatterns("/**");
        }
    }
    ...
    private boolean validateSign(HttpServletRequest request) {
        ...
        //判断是否已有该用户登录的session
        if (session.getAttribute(ProjectConstant.SESSION_KEY_ID) != null) {
            return true;
        }
        return false;
