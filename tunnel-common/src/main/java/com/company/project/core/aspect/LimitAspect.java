...
import com.company.project.core.annotation.Limit;
import com.company.project.core.exception.LimitAccessException;
import com.company.project.core.model.LimitType;
...
/**
 * 接口限流注解，示例见 com.max.common.controller.TestController
 */
@Aspect
@Component
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.company.project.core.annotation.Limit)")
