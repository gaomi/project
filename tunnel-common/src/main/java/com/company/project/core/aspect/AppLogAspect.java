...
public class AppLogAspect {
    ...
    @Pointcut("@annotation(com.company.project.core.annotation.AppLog)")
    ...
    public Object around(ProceedingJoinPoint point) throws JsonProcessingException {
        ...
        if (paodingProperties.isOpenAopLog()) {
            ...
            Object sessionKey = request.getSession().getAttribute(ProjectConstant.SESSION_KEY);
            String userName = "";
            if (sessionKey != "" && sessionKey != null) {
                SysUser user = (SysUser) sessionKey;
